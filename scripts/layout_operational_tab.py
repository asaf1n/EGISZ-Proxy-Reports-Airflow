...
SENT_LAYOUT: dict[str, tuple[int, int, int, int]] = {
    "Отправлено без вердикта": (0, 0, 6, 3),
    "В обработке": (0, 6, 6, 3),
    "Без ответа": (0, 12, 6, 3),
    "Доля без ответа, %": (0, 18, 6, 3),
    "Отправленные документы": (3, 0, 24, 10),
    "Топ клиник по документам в обработке > 1 суток": (13, 0, 12, 7),
    "Ступени обработки": (13, 12, 12, 7),
    "Топ типов СЭМД по документам в обработке > 1 суток": (20, 0, 24, 7),
}
