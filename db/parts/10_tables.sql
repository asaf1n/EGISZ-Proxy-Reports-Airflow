...
-- Service audit data mart input tables. These tables are intentionally small,
-- source-agnostic DWH contracts for commercial/service analytics that are not
-- derivable from the EGISZ transport log alone.
...
ALTER TABLE clients ADD COLUMN IF NOT EXISTS tier text NOT NULL DEFAULT 'unknown';
ALTER TABLE clients ADD COLUMN IF NOT EXISTS region text;
ALTER TABLE clients ADD COLUMN IF NOT EXISTS branches_count integer NOT NULL DEFAULT 1;
ALTER TABLE clients ADD COLUMN IF NOT EXISTS licenses_count integer NOT NULL DEFAULT 0;
ALTER TABLE clients ADD COLUMN IF NOT EXISTS signup_date date NOT NULL DEFAULT CURRENT_DATE;
...
CREATE TABLE IF NOT EXISTS subscriptions (
    ...
    ended_at date,
    compliance_plus_flag boolean NOT NULL DEFAULT false,
    created_at timestamptz NOT NULL DEFAULT now(),
    updated_at timestamptz NOT NULL DEFAULT now()
);

ALTER TABLE subscriptions ADD COLUMN IF NOT EXISTS client_id bigint;
ALTER TABLE subscriptions ADD COLUMN IF NOT EXISTS tier text;
ALTER TABLE subscriptions ADD COLUMN IF NOT EXISTS monthly_fee numeric(14, 2) NOT NULL DEFAULT 0;
ALTER TABLE subscriptions ADD COLUMN IF NOT EXISTS started_at date;
ALTER TABLE subscriptions ADD COLUMN IF NOT EXISTS ended_at date;
ALTER TABLE subscriptions ADD COLUMN IF NOT EXISTS compliance_plus_flag boolean NOT NULL DEFAULT false;
...
ALTER TABLE billing ADD COLUMN IF NOT EXISTS client_id bigint;
ALTER TABLE billing ADD COLUMN IF NOT EXISTS month date;
ALTER TABLE billing ADD COLUMN IF NOT EXISTS amount_billed numeric(14, 2) NOT NULL DEFAULT 0;
ALTER TABLE billing ADD COLUMN IF NOT EXISTS amount_paid numeric(14, 2) NOT NULL DEFAULT 0;
ALTER TABLE billing ADD COLUMN IF NOT EXISTS payment_date date;
...
ALTER TABLE tickets ADD COLUMN IF NOT EXISTS l1_l2_l3 text;
ALTER TABLE tickets ADD COLUMN IF NOT EXISTS resolution_time_hours numeric(12, 2);
...
CREATE TABLE IF NOT EXISTS sla_metrics (
    ...
    mttr_p1_hours numeric(12, 2),
    response_time_p95_hours numeric(12, 2),
    created_at timestamptz NOT NULL DEFAULT now(),
    updated_at timestamptz NOT NULL DEFAULT now()
);

ALTER TABLE sla_metrics ADD COLUMN IF NOT EXISTS client_id bigint;
ALTER TABLE sla_metrics ADD COLUMN IF NOT EXISTS month date;
ALTER TABLE sla_metrics ADD COLUMN IF NOT EXISTS uptime_pct numeric(6, 3);
ALTER TABLE sla_metrics ADD COLUMN IF NOT EXISTS mttr_p1_hours numeric(12, 2);
ALTER TABLE sla_metrics ADD COLUMN IF NOT EXISTS response_time_p95_hours numeric(12, 2);
ALTER TABLE sla_metrics ADD COLUMN IF NOT EXISTS created_at timestamptz NOT NULL DEFAULT now();
ALTER TABLE sla_metrics ADD COLUMN IF NOT EXISTS updated_at timestamptz NOT NULL DEFAULT now();

CREATE TABLE IF NOT EXISTS sed_transfers (
    id bigint PRIMARY KEY,
    client_id bigint NOT NULL REFERENCES clients(id) ON DELETE CASCADE,
    document_type text,
...
ALTER TABLE sed_transfers ADD COLUMN IF NOT EXISTS client_id bigint;
ALTER TABLE sed_transfers ADD COLUMN IF NOT EXISTS document_type text;
ALTER TABLE sed_transfers ADD COLUMN IF NOT EXISTS created_at timestamptz;
ALTER TABLE sed_transfers ADD COLUMN IF NOT EXISTS sent_at timestamptz;
ALTER TABLE sed_transfers ADD COLUMN IF NOT EXISTS registered_at timestamptz;
ALTER TABLE sed_transfers ADD COLUMN IF NOT EXISTS status text NOT NULL DEFAULT 'created';
ALTER TABLE sed_transfers ADD COLUMN IF NOT EXISTS error_code text;
ALTER TABLE sed_transfers ADD COLUMN IF NOT EXISTS loaded_at timestamptz NOT NULL DEFAULT now();
ALTER TABLE sed_transfers ADD COLUMN IF NOT EXISTS updated_at timestamptz NOT NULL DEFAULT now();
...
CREATE TABLE IF NOT EXISTS churn_events (
    ...
    reason text,
    exit_revenue_lost numeric(14, 2) NOT NULL DEFAULT 0,
    created_at timestamptz NOT NULL DEFAULT now(),
    updated_at timestamptz NOT NULL DEFAULT now()
);

ALTER TABLE churn_events ADD COLUMN IF NOT EXISTS client_id bigint;
ALTER TABLE churn_events ADD COLUMN IF NOT EXISTS churn_date date;
ALTER TABLE churn_events ADD COLUMN IF NOT EXISTS reason text;
ALTER TABLE churn_events ADD COLUMN IF NOT EXISTS exit_revenue_lost numeric(14, 2) NOT NULL DEFAULT 0;
ALTER TABLE churn_events ADD COLUMN IF NOT EXISTS created_at timestamptz NOT NULL DEFAULT now();
ALTER TABLE churn_events ADD COLUMN IF NOT EXISTS updated_at timestamptz NOT NULL DEFAULT now();

CREATE TABLE IF NOT EXISTS client_costs_monthly (
    client_id bigint NOT NULL REFERENCES clients(id) ON DELETE CASCADE,
    month date NOT NULL,
...
ALTER TABLE client_costs_monthly ADD COLUMN IF NOT EXISTS client_id bigint;
ALTER TABLE client_costs_monthly ADD COLUMN IF NOT EXISTS month date;
ALTER TABLE client_costs_monthly ADD COLUMN IF NOT EXISTS category text;
ALTER TABLE client_costs_monthly ADD COLUMN IF NOT EXISTS cost numeric(14, 2) NOT NULL DEFAULT 0;
ALTER TABLE client_costs_monthly ADD COLUMN IF NOT EXISTS created_at timestamptz NOT NULL DEFAULT now();
ALTER TABLE client_costs_monthly ADD COLUMN IF NOT EXISTS updated_at timestamptz NOT NULL DEFAULT now();
...
CREATE INDEX IF NOT EXISTS idx_subscriptions_client_active ON subscriptions (client_id, started_at, ended_at);
CREATE INDEX IF NOT EXISTS idx_subscriptions_tier ON subscriptions (tier);
CREATE INDEX IF NOT EXISTS idx_billing_client_month ON billing (client_id, month);
CREATE INDEX IF NOT EXISTS idx_tickets_client_opened ON tickets (client_id, opened_at);
CREATE INDEX IF NOT EXISTS idx_tickets_severity_opened ON tickets (severity, opened_at);
CREATE INDEX IF NOT EXISTS idx_sla_metrics_client_month ON sla_metrics (client_id, month);
CREATE INDEX IF NOT EXISTS idx_sed_transfers_client_created ON sed_transfers (client_id, created_at);
CREATE INDEX IF NOT EXISTS idx_sed_transfers_status_created ON sed_transfers (status, created_at);
CREATE INDEX IF NOT EXISTS idx_churn_events_client_date ON churn_events (client_id, churn_date);
CREATE INDEX IF NOT EXISTS idx_client_costs_monthly_client_month ON client_costs_monthly (client_id, month);
