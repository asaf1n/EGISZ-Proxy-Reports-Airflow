...
| Категория | Тип ошибки (`error_type`) |
| --- | --- |
| Данные пациента | Не указан адрес пациента |
| Данные пациента | ФИО пациента не заполнено или некорректно |
| Данные пациента | Дата рождения пациента не заполнена или некорректна |
| Данные пациента | СНИЛС пациента не заполнен или некорректен |
| Данные пациента | Данные пациента не соответствуют ГИП |
| Данные пациента | ФИО пациента в ЭМД не соответствует данным ЕГИСЗ |
| Данные пациента | Пол пациента в ЭМД не соответствует данным ЕГИСЗ |
| Данные пациента | Неверный формат или контрольная сумма СНИЛС |
| Данные пациента | СНИЛС не найден или не соответствует данным пациента/медработника |
| Данные пациента | Получатель из запроса не найден в СЭМД |
| Данные пациента | Документ, удостоверяющий личность пациента: некорректные реквизиты |
| Данные медработника | Специальность врача не соответствует справочнику НСИ |
| Данные медработника | СНИЛС автора (врача) не заполнен или некорректен |
| Данные медработника | Данные организации автора документа не заполнены |
| Данные медработника | Должность врача не соответствует данным ФРМР |
| Данные медработника | Медработник не найден в ФРМР |
| Данные медработника | Данные медработника не соответствуют ФРМР |
| Данные медработника | Подписант из сертификата не найден в ФРМР |
| Данные медработника | Отчество врача не соответствует данным СЭМД |
| Ошибки структуры и валидации | Организация не привязана к РМИС |
| Ошибки структуры и валидации | Некорректно заполнен телефон |
| Ошибки структуры и валидации | Данные заверителя документа не заполнены или некорректны |
| Ошибки структуры и валидации | Дата/время создания документа не заполнены или некорректны |
| Ошибки структуры и валидации | Код типа документа не соответствует справочнику НСИ |
| Ошибки структуры и валидации | Данные хранителя документа не заполнены |
| Ошибки структуры и валидации | Ошибка XSD-валидации XML |
| Ошибки структуры и валидации | Ошибка разбора XML-структуры документа |
| Ошибки справочника НСИ | Неактуальная версия справочника НСИ |
| Ошибки справочника НСИ | Код отсутствует в справочнике НСИ |
| Ошибки справочника НСИ | Наименование не соответствует справочнику НСИ |
| Ошибки справочника НСИ | Ошибка справочника НСИ |
| Ошибки регистрации в РЭМД | Документ уже зарегистрирован в РЭМД |
| Ошибки регистрации в РЭМД | Документ не найден в РЭМД |
| Ошибки регистрации в РЭМД | Неверный идентификатор документа РЭМД |
| Ошибки регистрации в РЭМД | Доступ к операции запрещён в РЭМД |
| Ошибки регистрации в РЭМД | Дублирующий запрос |
| Ошибки регистрации в РЭМД | Неподдерживаемый тип СЭМД в РЭМД |
| Ошибки регистрации в РЭМД | Неверный формат запроса |
| Ошибки регистрации в РЭМД | Идентификатор документа в ЭМД не совпадает с идентификатором в запросе на регистрацию |
| Ошибки регистрации в РЭМД | Дата создания документа в ЭМД не совпадает с датой в запросе на регистрацию |
| Ошибки регистрации в РЭМД | Дата подписи МО позже даты поступления запроса на регистрацию |
| Ошибки регистрации в РЭМД | Структурное подразделение (providerOrganization) в СЭМД не совпадает с запросом на регистрацию |
| Ошибки регистрации в РЭМД | Структурное подразделение (representedOrganization) в СЭМД не совпадает с запросом на регистрацию |
| Ошибки регистрации в РЭМД | Для данного вида ЭМД запрещена регистрация новых версий |
| Ошибки регистрации в РЭМД | Метаописание документа не соответствует зарегистрированному в РЭМД |
| Ошибки регистрации в РЭМД | Вид документа не актуален на дату создания |
| Ошибки регистрации в РЭМД | Подразделение или запись справочника не найдены на дату документа |
| Ошибки регистрации в РЭМД | Документ аннулирован |
| Ошибки организации / ИС | Несоответствие данных организации в ФРМО |
| Ошибки организации / ИС | Организация не найдена в реестре РЭМД |
| Ошибки организации / ИС | Организация не зарегистрирована в РЭМД |
| Ошибки организации / ИС | Лицензия организации не найдена |
| Ошибки организации / ИС | ИС зарегистрирована в РЭМД, но не активна: проверьте уведомления и переподключение ИС |
| Ошибки организации / ИС | ИС не зарегистрирована в РЭМД или указаны неверные регистрационные данные |
| Ошибки организации / ИС | Ошибки организации |
| Ошибки получения файла ЭМД | Сервис предоставляющей ИС недоступен: проверьте доступность getDocumentFile |
| Ошибки получения файла ЭМД | Запрашиваемая запись ЭМД не найдена в предоставляющей ИС |
| Ошибки получения файла ЭМД | ИС не передала файл ЭМД в ответе getDocumentFile |
| Ошибки получения файла ЭМД | Не удалось получить файл ЭМД из предоставляющей ИС |
| Ошибки ЭП и сертификатов | Не удалось проверить электронную подпись |
| Ошибки ЭП и сертификатов | Данные подписи не соответствуют данным документа |
| Ошибки ЭП и сертификатов | Подпись роли не соответствует требованиям РЭМД |
| Ошибки ЭП и сертификатов | Недействительный сертификат подписи |
| Ошибки ЭП и сертификатов | Сертификат подписи недействителен на дату создания документа |
| Ошибки ЭП и сертификатов | Сертификат ЭП истёк |
| Ошибки ЭП и сертификатов | Сертификат ЭП отозван |
| Ошибки ЭП и сертификатов | Срок действия сертификата организации истек |
| Ошибки ЭП и сертификатов | Недоступен сервис проверки статуса сертификата (CRL/OCSP) |
| Технические ошибки РЭМД | РЭМД не смог обработать запрос |
| Технические ошибки РЭМД | Техническая ошибка на стороне РЭМД |
| Технические ошибки РЭМД | Таймаут асинхронной обработки на стороне РЭМД |
| Технические ошибки РЭМД | Недоступен сервис проверки подписи (УЦ) на стороне РЭМД |
